    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 via-emerald-50 to-amber-50">
      <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              asChild
              className="hidden sm:inline-flex bg-gradient-to-r from-green-600 to-emerald-600"
            >
      ...
      <footer className="mt-12 bg-gradient-to-b from-emerald-900 to-emerald-950 text-emerald-100">
        <div className="container mx-auto px-4 py-10 grid gap-8 md:grid-cols-4">
          <div>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-emerald-200">
                  Carbon Credit Solutions for Indian Farmers
                </div>
              </div>
            </div>
            <p className="text-sm mt-3 text-emerald-200/90">
              The most trusted and easy-to-use carbon credit platform for Indian
              farmers. Our mission is to connect smallholder farmers with carbon
              markets.
            </p>
            <div className="flex gap-3 mt-3">
              <a
                href="#"
                aria-label="Facebook"
                className="h-8 w-8 rounded-md bg-emerald-800/60 inline-flex items-center justify-center border border-emerald-700/60"
              >
          ...
          <div>
            ...
            <ul className="text-sm space-y-1 text-emerald-100/90">
              <li>
                <a href="https://agricoop.gov.in/en/about-us">About Us</a>
              </li>
              <li>
                <Link to="/support">Support</Link>
              </li>
              <li>
                <a href="https://farmer.gov.in/Content/privacy-policy.aspx">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="https://farmer.gov.in/Content/terms-conditions.aspx">
                  Terms & Conditions
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="text-sm space-y-1 text-emerald-100/90">
              ...
              <li>
                <Link to="/support">Tutorials</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm space-y-2 text-emerald-100/90">
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4" /> +91 6246-789-012
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4" /> support@innovativemind.in
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="mt-4">
              <div className="text-xs mb-2 text-emerald-200">
                Download Mobile App:
              </div>
              <div className="flex gap-2">
                <a
                  href="#"
                  className="h-10 px-3 rounded-md bg-black text-white text-xs inline-flex items-center gap-2"
                >
        ...
        <div className="border-t border-emerald-800/50">
          <div className="container mx-auto px-4 py-4 text-xs text-emerald-200">
            © {new Date().getFullYear()} Innovative Mind. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
